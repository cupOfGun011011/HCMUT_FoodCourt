...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _User = __webpack_require__(/*! ./models/User */ \"./src/js/models/User.js\");\n\nvar _User2 = _interopRequireDefault(_User);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar controlLogin = function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n    var user, email, password, crediential, userInfo;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            user = new _User2.default();\n            email = _base.element.emailInput.value;\n            password = _base.element.passwordInput.value;\n            crediential = {\n              email: email,\n              password: password\n            };\n            _context.prev = 4;\n            _context.next = 7;\n            return _axios2.default.post(_base.serverAPI + \"/user/login\", crediential);\n\n          case 7:\n            userInfo = _context.sent;\n\n            console.log(userInfo);\n            user.setUser(userInfo.data.user, userInfo.data.token);\n            user.saveStorage();\n            window.location.href = _base.serverAPI + \"/home-page\";\n            _context.next = 17;\n            break;\n\n          case 14:\n            _context.prev = 14;\n            _context.t0 = _context[\"catch\"](4);\n\n            _base.element.serverMessage.textContent = \"Wrong email or password, please try again\";\n\n          case 17:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, undefined, [[4, 14]]);\n  }));\n\n  return function controlLogin() {\n    return _ref.apply(this, arguments);\n  };\n}();\n// TODO: Reconfigure webpack for multiple page, add navigation to homepage\n_base.element.loginForm.addEventListener(\"submit\", function (e) {\n  e.preventDefault();\n  controlLogin();\n});\n\nconsole.log(\"TEST\");\nconsole.log(\"TEST\");\n\n//# sourceURL=webpack:///./src/js/login.js?");
